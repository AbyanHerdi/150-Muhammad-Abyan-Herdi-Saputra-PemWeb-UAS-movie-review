<?php
// File: tukar takdir.php (UPDATED - Consistent with film.sore.php)
...
$defaultTitle = 'Tukar Takdir';
$defaultPoster = 'uploads/posters/poster_tukartakdir.jpg';
$defaultYear = '2024';
$defaultGenre = 'Drama, Fantasi';
...
<body>
        ...
        <section class="movie-header">
            ...
            <div class="movie-info">
                ...
                <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                    <button id="likeButton" class="submit-btn like-btn" data-movie-id="TUKAR_TAKDIR">
                    ...
                    <a href="ulasan_tukartakdir.php" class="submit-btn review-link" style="text-decoration: none; display: inline-block;">
    ...
    <script>
        const STORAGE_KEY = 'tukarTakdirReviews';
        ...
        const TRAILER_URL = 'uploads/videos/1763219481_𝐓𝐔𝐊𝐀𝐑 𝐓𝐀𝐊𝐃𝐈𝐑 - 𝘖𝘍𝘍𝘐𝘊𝘐𝘈𝘓 𝘛𝘙𝘈𝘐𝘓𝘌𝘙.mp4';
        ...
        function loadReviewsAndStats() {
            fetch('tukar takdir.php?fetch_data=1')
