<?php
// File: rangga & cinta.php (UPDATED - Consistent with film.sore.php)
...
$defaultTitle = 'Ada Apa Dengan Cinta? (Rangga & Cinta)';
$defaultPoster = 'uploads/posters/poster_aadc.jpg';
$defaultYear = '2002';
$defaultGenre = 'Drama, Romantis';
$defaultDirector = 'Rudy Soedjarwo';
$defaultCast = 'Dian Sastrowardoyo, Nicholas Saputra';
...
<body>
    <div class="container">
        ...
        <section class="movie-header">
            ...
            <div class="movie-info">
                ...
                <p><?= htmlspecialchars($releaseYear); ?> • <?= htmlspecialchars($genre); ?> • 1h 52m</p>
                <p>Sutradara: <?= htmlspecialchars($director); ?> • Pemain: <?= htmlspecialchars($cast); ?></p>
                
                <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                    <button id="likeButton" class="submit-btn like-btn" data-movie-id="RANGGA_CINTA">
                    ...
                    <a href="ulasan rangga.html" class="submit-btn review-link" style="text-decoration: none; display: inline-block;">
    ...
    <script>
        const STORAGE_KEY = 'ranggaCintaReviews';
        ...
        const TRAILER_URL = 'uploads/videos/RANGGA_CINTA___OFFICIALTRAILER.mp4';
        ...
        function loadReviewsAndStats() {
            fetch('rangga & cinta.php?fetch_data=1')
